...
optionsBuilder.UseSqlServer(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Repos\Other\QuartzNETDemo\QuartzNETDemoConsoleApp\Database1.mdf;Integrated Security=True;Connect Timeout=30");
